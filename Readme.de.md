...
- **CrofAI, NanoGPT, Chutes.ai und LocalAI** als neue unterstützte Übersetzungsbackends, jeweils mit Quota-Verfolgung.
...
- **Inline-Untertitelvergleich und Bearbeitung.** Originale und übersetzte Untertitel nebeneinander vergleichen, einzelne Zeilen bearbeiten und direkt im Dashboard genehmigen oder ablehnen.
- **Untertitel-Integritätsprüfung.** Automatisierte Qualitätsprüfung über deine gesamte Mediathek mit konfigurierbaren Zeitplänen.
- **Eigene Übersetzungsquellen.** Eigene Übersetzungs-API oder selbst gehostete LLM-Provider über die Custom Sources-Einstellungsseite einbinden.
