...
type QueryParamValue = QueryParamPrimitive | QueryParamPrimitive[] | QueryParamObject
...
declare global {
    interface String {
         ...
         */
        addParams(params: Record<string, QueryParamValue>): string
...
String.prototype.addParams = function (params: Record<string, QueryParamValue>): string {
