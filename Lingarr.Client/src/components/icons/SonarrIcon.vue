<template>
    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 512 512">
        <path
            ...
            style="fill-rule: evenodd; clip-rule: evenodd; fill: #eee" />
        <path
            ...
            style="fill-rule: evenodd; clip-rule: evenodd; fill: #3a3f51" />
        <path
            ...
            style="fill-rule: evenodd; clip-rule: evenodd; fill: #0cf" />
        <path
            d="m372.7 141-35.4 34.6M72.9 76.8l96.5 96.1m199.7 198.9 65.6 67.9m4.4-363.3L372.7 141M76.6 438.5l64.6-64.7"
            style="fill: none; stroke: #0cf; stroke-width: 2; stroke-miterlimit: 1" />
        <path
            d="m372.7 141-40 40.6m-193.3-38.5 40.6 40.5M141 374l39.5-41.1m146.2-3.3 42.6 42.4"
            style="fill: none; stroke: #0cf; stroke-width: 7; stroke-miterlimit: 1" />
    </svg>
</template>
