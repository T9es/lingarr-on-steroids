    ...
    <svg
        ...
        <g id="Group-Copy" transform="translate(70 21)">
            <path
                ...
                style="fill: #24292e" />
            <path
                id="Shape_00000114049535938561773820000018271523940913105341_"
                d="M-13.2 451.8c23.5 7.8 47 3.9 66.6-7.8l321.5-188.2c19.6 27.4 15.7 54.9-7.8 70.6L96.5 483.2c-39.2 19.6-90.1 0-109.7-31.4"
                style="fill: #24292e" />
            <path
                id="Shape_00000165935924413286433040000003668002807793862576_"
                d="M80.9 342 273 232.3 84.8 126.4z"
                style="fill: #ffc230" />
        </g>
    </svg>
</template>
