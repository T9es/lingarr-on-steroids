<template>
    <div
        :class="[
            'relative h-full rounded-md bg-linear-to-br from-secondary to-tertiary p-4 shadow-md transition-all duration-200',
        ...
        <div
            v-if="isConfigMode"
            class="bg-accent/20 absolute top-2 left-2 cursor-grab rounded px-2 py-1 text-xs active:cursor-grabbing select-none">
            ⋮⋮
        </div>
