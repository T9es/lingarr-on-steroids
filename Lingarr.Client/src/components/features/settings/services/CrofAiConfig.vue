...
const aiModel = computed({
    get: () => settingsStore.getSetting(SETTINGS.CROFAI_MODEL) as string,
    set: (newValue: string) => {
        settingsStore.updateSetting(SETTINGS.CROFAI_MODEL, newValue, true)
        emit('save')
    }
})

const apiKey = computed({
    get: () => settingsStore.getSetting(SETTINGS.CROFAI_API_KEY) as string,
    set: (newValue: string) => {
        settingsStore.updateSetting(SETTINGS.CROFAI_API_KEY, newValue, apiKeyIsValid.value)
