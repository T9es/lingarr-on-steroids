...
public class SubtitleQualityAuditJob
{
        ...
        SubtitleQualityValidationResult validationResult)
    {
        result.Findings.Add(new SubtitleQualityAuditFinding
        {
            ...
            SourceSubtitleSnapshot = request.SourceSnapshotFingerprint ?? request.SourceSnapshotIdentity,
            SourceSubtitleEntryCount = request.SourceSubtitleEntryCount,
            SourcePath = sourcePath,
            TargetPath = targetPath,
            OutputFormat = outputFormat,
            GeneratedSubtitlePaths = request.GeneratedSubtitlePaths,
