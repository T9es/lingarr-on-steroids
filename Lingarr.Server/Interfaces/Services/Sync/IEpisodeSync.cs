...
public interface IEpisodeSync
{
    ...
    /// <param name="existingEpisodes">Optional pre-loaded episode entities to update</param>
    /// <returns>A task representing the asynchronous operation</returns>
    Task SyncEpisodes(SonarrShow show, Season season, List<Episode>? existingEpisodes = null);
}