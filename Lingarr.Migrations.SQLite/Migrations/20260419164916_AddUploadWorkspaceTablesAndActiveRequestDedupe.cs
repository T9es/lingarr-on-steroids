        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                SET required_output_formats = CASE
                    WHEN lower(ifnull(trim(subtitle_output_mode), '')) = 'srt-only' THEN '.srt'
                    WHEN lower(ifnull(trim(source_subtitle_format), '')) IN ('ass', '.ass') AND
                         lower(ifnull(trim(subtitle_output_mode), '')) = 'both' THEN '.ass,.srt'
                    WHEN lower(ifnull(trim(source_subtitle_format), '')) IN ('ssa', '.ssa') AND
                         lower(ifnull(trim(subtitle_output_mode), '')) = 'both' THEN '.srt,.ssa'
                    WHEN source_subtitle_format IS NULL OR trim(source_subtitle_format) = '' THEN '.srt'
                    WHEN lower(trim(source_subtitle_format)) IN ('subrip', 'mov_text') THEN '.srt'
                    WHEN lower(trim(source_subtitle_format)) = 'webvtt' THEN '.vtt'
                    WHEN lower(trim(source_subtitle_format)) = 'ass' THEN '.ass'
                    WHEN lower(trim(source_subtitle_format)) = 'ssa' THEN '.ssa'
                    WHEN substr(trim(source_subtitle_format), 1, 1) = '.' THEN lower(trim(source_subtitle_format))
                    ELSE '.' || lower(trim(source_subtitle_format))
                END
                WHERE is_active = 1
                  AND (required_output_formats IS NULL OR trim(required_output_formats) = '');
                """);
            ...
            migrationBuilder.Sql(
                ...
                SET is_active = NULL,
                    status = CASE
                        WHEN status IN (0, 1) THEN 5
                        ELSE status
                    END,
                    completed_at = CASE
                        WHEN status IN (0, 1) AND completed_at IS NULL THEN CURRENT_TIMESTAMP
                        ELSE completed_at
                    END
                WHERE id IN (
                    SELECT id
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_language = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    storage_path = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    status = table.Column<int>(type: "INTEGER", nullable: false),
                    default_remux_enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    failure_reason = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    original_file_name = table.Column<string>(type: "TEXT", maxLength: 260, nullable: false),
                    stored_path = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    relative_stored_path = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    file_size_bytes = table.Column<long>(type: "INTEGER", nullable: false),
                    detected_source_language = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    selected_source_language = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    exclude_from_translation = table.Column<bool>(type: "INTEGER", nullable: false),
                    embed_translated_subtitle = table.Column<bool>(type: "INTEGER", nullable: false),
                    selected_embedded_stream_index = table.Column<int>(type: "INTEGER", nullable: true),
                    selected_embedded_stream_language = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    selected_embedded_stream_title = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    selected_embedded_stream_codec = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    current_translation_request_id = table.Column<int>(type: "INTEGER", nullable: true),
                    probe_completed_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    started_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    completed_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    probe_error = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    last_error = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    relative_path = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    file_size_bytes = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    codec_name = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_upload_batch_file_subtitle_streams_upload_batch_files_upload_batch_file_id",
                        column: x => x.upload_batch_file_id,
                        principalTable: "upload_batch_files",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
